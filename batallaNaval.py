...
def mostraTableros(tableroDisparosJugador, tableroDisparosOponente):
    print("\n Tablero de Disparos")
    ...
    for barco in barcos:
        ...
        while not colocado:
            ...
            if validarColocacion(tablero, fila, columna, barco['dimension'], orientacion):
                ...
                print("Colocacion invalida, intente de nuevo")
...
def jugarContraComputadora():
    ...
    while True:
        if turnoJugador:
            print("\nTu turno")
            mostraTableros(tableroDisparosJugador, tableroDisparosComputadora)
...
def jugarDosJugadores():
    ...
    while True:
        if turnoJugador1:
            print("\nTu turno Jugador 1")
            mostraTableros(tableroDisparosJugador1, tableroDisparosJugador2)
            fila = int(input("Ingresa la fila del disparo: "))
            columna = int(input("Ingresa la columna del disparo: "))
            ...
            print("\n Turno del Jugador 2")
            mostraTableros(tableroDisparosJugador2, tableroDisparosJugador1)
            fila = int(input("Ingresa la fila del disparo: "))
            columna = int(input("Ingresa la columna del disparo: "))
...
def iniciarJuego():
    while True:
        ...
        if modo == "1":
            ...
            print("Opcion no valida, por favor elige una correcta")
            continue
        print(f"El ganador es {ganador}")
        jugarDeNuevo = input("Quieres jugar de nuevo? (s/n): ").lower()
        if jugarDeNuevo !="s":
            print("Gracias por jugar, por favor no vuelvas")
            break
